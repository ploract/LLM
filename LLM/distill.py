...
if __name__ == '__main__':    # 只有当前文件执行，才会执行，而不是被import后就执行
    ...
    parser.add_argument("--wandb_project", type=str, default="Ploract-distill")  # wandb项目名称
    ...
    # 设置wandb运行名称
    args.wandb_run_name = f"Ploract-distill-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
